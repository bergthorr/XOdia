   ...
   /* void check_around(char array[20][20][9],int i,int j)
    ...
    int scan4kill(char array[20][20][9],int i,int j,int l)
     ...
     {int k;
  	 ...
  	 {
        c=array[i][j+1][0];
        if(c=='1'&&l!=3&&array[i][j+1][7]!='1')
         {
     	   return 3;
        	}
         c=array[i+1][j+1][0];
         if(c=='1'&&l!=4&&array[i+1][j+1][8]!='1')
         {
         	return 4;
       	}
         c=array[i+1][j][0];
         if(c=='1'&&l!=5&&array[i+1][j][1]!='1')
       	{
         	return 5;
   		}
         return 0;
    ...
    else if (i==0&&j==19)
         {
				...
				c=array[i+1][j-1][0];
				if(c=='1'&&l!=6&&array[i+1][j-1][2]!='1')
				{
				return 6;
				}
				c=array[i][j-1][0];
				if(c=='1'&&l!=7&&array[i][j-1][3]!='1')
				{
				return 7;
				}
				return 0;
			...
			{   c=array[i-1][j][0];
				if(c=='1'&&l!=1&&array[i-1][j][5]!='1')
				{
				return 1;
				}
				c=array[i-1][j+1][0];
         	if(c=='1'&&l!=2&&array[i-1][j+1][6]!='1')
        		{
         		return 2;
        		}
         	c=array[i][j+1][0];
     ...
     int scan4node(char array[20][20][9],int i,int j,int l)
          {int k;
       	 ...
       	 {
             c=array[i][j+1][0];
             if((c=='3'||c=='4')&&l!=3&&array[i][j+1][7]!='1')
              {
          	   return 3;
             	}
              c=array[i+1][j+1][0];
              if((c=='3'||c=='4')&&l!=4&&array[i+1][j+1][8]!='1')
              {
              	return 4;
            	}
              c=array[i+1][j][0];
              if((c=='3'||c=='4')&&l!=5&&array[i+1][j][1]!='1')
            	{
              	return 5;
        		}
              return 0;
         ...
         else if (i==0&&j==19)
              {
     				...
     				c=array[i+1][j-1][0];
     				if((c=='3'||c=='4')&&l!=6&&array[i+1][j-1][2]!='1')
     				{
     				return 6;
     				}
     				c=array[i][j-1][0];
     				if((c=='3'||c=='4')&&l!=7&&array[i][j-1][3]!='1')
     				{
     				return 7;
     				}
     				return 0;
     			...
     			{   c=array[i-1][j][0];
     				if((c=='3'||c=='4')&&l!=1&&array[i-1][j][5]!='1')
     				{
     				return 1;
     				}
     				c=array[i-1][j+1][0];
              	if((c=='3'||c=='4')&&l!=2&&array[i-1][j+1][6]!='1')
             		{
              		return 2;
             		}
              	c=array[i][j+1][0];
              	...
              	return 0;
              ...
              else if (i==19&&j==19)
          			{
     						...
     						c=array[i-1][j-1][0];
     						if((c=='3'||c=='4')&&l!=8&&array[i-1][j-1][4]!='1')
     						{
     							return 8;
     						}
     						c=array[i-1][j][0];
